...
int main()
{
    ...
    pool.add({ "instance.vert", "instance.frag" });
    ...
    unsigned int instanceVBO;
    {
        ...
        v.bind(vertices, 30).setVertexAttrib(3, 2, 0);
        ...
        for (int y = -10; y < 10; y += 2) {
            for (int x = -10; x < 10; x += 2) {
                translations[id++] = glm::vec2(0.1f * x + interval, 0.1f * y + interval);
            }
        }

        {
            ...
            // 设置更新
            glVertexAttribDivisor(2, 1); // 有2个v.VBO=0 instanceVBO=1
        }
    }
